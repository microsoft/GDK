...
•	**Download:** Go to the [https://github.com/microsoft/GDK/releases](Releases) page and pick the latest and greatest [https://github.com/microsoft/GDK/releases/latest]. 
